...
function Navbar() {
  ...
  return (
    <nav className="site-nav sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur dark:bg-gray-900/90 dark:border-gray-700 transition-colors">
